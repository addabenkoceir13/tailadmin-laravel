            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <div class="relative" x-data="{ languageOpen: false, activeLanguage: 'EN' }" @click.away="languageOpen = false">
                    <button
                        ...
                        {!! IconsHelper::icon('globe', 'h-4 w-4 text-gray-500 dark:text-gray-400') !!}
                        <span x-text="activeLanguage"></span>
                        <span class="text-gray-500 transition-transform dark:text-gray-400" :class="languageOpen ? 'rotate-180' : ''">
                            {!! IconsHelper::icon('chevron-down-solid', 'h-4 w-4') !!}
                        </span>
                    </button>
