...
<div x-data="{
    ...
    <div class="relative custom-datepicker">
        <input
            ...
            class="h-11 w-full rounded-lg pr-10 rtl:pr-4 rtl:pl-10 border appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 bg-transparent text-gray-800 border-gray-300 focus:border-brand-300 focus:ring-brand-500/20 dark:border-gray-700 dark:focus:border-brand-800"
            autocomplete="off"
        />
        <span class="absolute text-gray-500 -translate-y-1/2 rtl:right-auto rtl:left-3 pointer-events-none right-3 top-1/2 dark:text-gray-400">
