        ...
        <div x-data="{ switcherToggle: false }">
            <label for="toggle1"
                ...
                <div class="relative">
                    ...
                    <div :class="switcherToggle ? 'translate-x-full rtl:-translate-x-full' : 'translate-x-0 rtl:translate-x-0'"
                        class="shadow-theme-sm absolute top-0.5 left-0.5 rtl:left-auto rtl:right-0.5 h-5 w-5 rounded-full bg-white duration-300 ease-linear">
                    </div>
                </div>
        ...
        <div x-data="{ switcherToggle: false }">
            <label for="toggle3"
                ...
                <div class="relative">
                    ...
                    <div :class="switcherToggle ? 'translate-x-full rtl:-translate-x-full' : 'translate-x-0 rtl:translate-x-0'"
                        class="shadow-theme-sm absolute top-0.5 left-0.5 rtl:left-auto rtl:right-0.5 h-5 w-5 rounded-full bg-gray-50 duration-300 ease-linear">
                    </div>
                </div>
