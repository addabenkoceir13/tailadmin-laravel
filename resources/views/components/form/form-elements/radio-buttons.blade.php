            ...
            <label for="radioLabelOne"
                ...
                <div class="relative">
                    ...
                    <div :class="checkboxToggle ? 'border-brand-500 bg-brand-500' :
                        ...
                        class="hover:border-brand-500 dark:hover:border-brand-500 mr-3 rtl:mr-0 rtl:ml-3 flex h-5 w-5 items-center justify-center rounded-full border-[1.25px]">
            ...
            <label for="radioLabelThree"
                ...
                <div class="relative">
                    ...
                    <div :class="checkboxToggle ? 'bg-transparent border-gray-300 dark:border-gray-700' :
                        ...
                        class="mr-3 rtl:mr-0 rtl:ml-3 flex h-5 w-5 items-center justify-center rounded-full border-[1.25px]">
                        <span class="h-2 w-2 rounded-full"
                            :class="checkboxToggle ? 'bg-white' : 'bg-white dark:bg-[#171f2e]'"></span>
                    </div>
                </div>
